...
int main() {
    ...
    while (1) {
        printf("Informe o valor que será inserido na árvore (0 para sair): ");
        scanf("%d", &leitura);
        if (leitura == 0)
            break;
        ...
        printf("Altura da subárvore esquerda: %d\n", alturaEsquerda);
        printf("Altura da subárvore direita: %d\n", alturaDireita);
    ...
    while (1) {
        printf("Informe o valor que será procurado na árvore (0 para sair): ");
        scanf("%d", &leitura);
        if (leitura == 0)
            break;
